...
public class UsuarioController {
    ...
    public void actualizar(@PathVariable final @NotNull Integer id, @RequestBody final @NotNull Usuario u, @RequestHeader Map<String, String> headers) {
    ...
    public void borrar(@PathVariable final @NotNull Integer id) {
    ...
    @GetMapping("/{id}")
    public Usuario listarUno(@PathVariable final @NotNull Integer id) {
